...
PUZZLE_CATALOG = {
    ...
    "hidden_objects": {"name": "Skryté předměty (Počítání)", "instr": "Počítání věcí na obrázku. Kód MUSÍ být číslo (např. '735'). DŮLEŽITÉ: Do textu 'zadani' MUSÍŠ EXPLICITNĚ VYPSAT očíslovaný seznam otázek, co má dítě počítat (např.: '1. Kolik je kuželů? 2. Kolik je cihel? 3. Kolik je kol?'). Nikdy nepiš jen obecné 'spočítej předměty'. Do anglického 'promptu' pro obrázek pak tyto předměty přesně vypiš, aby je generátor opravdu nakreslil."},
