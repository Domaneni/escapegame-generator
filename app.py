...
PUZZLE_CATALOG = {
    "matching": {"name": "Přiřazování předmětů", "instr": "Spojování souvisejících dvojic (např. profese a nástroj, zvíře a jídlo). DŮLEŽITÉ PRAVIDLO: Počet dvojic se musí PŘESNĚ rovnat délce tajného slova! Do textu 'zadani' MUSÍŠ EXPLICITNĚ vypsat dva zpřeházené sloupce věcí ke spojení a k jednomu sloupci přiřadit písmena z tajného kódu (např. Zedník -> Cihla = S, Tesař -> Kladivo = T). Z logiky jejich spojení musí jít přečíst tajné slovo zleva doprava. Do anglického 'promptu' pro obrázek vypiš všechny tyto předměty, ať je ilustrátor nakreslí."},    "logic_elimination": {"name": "Logická vyřazovačka", "instr": "4 dveře a 3 logické nápovědy. Zbydou jen jedny správné."},
    "hidden_objects": {"name": "Skryté předměty (Počítání)", "instr": "Počítání věcí na obrázku. IGNORUJ POKYN PRO SLOVNÍ KÓD! Tady MUSÍ být kód POUZE ČÍSLO (např. '243'). Počet číslic = počet otázek v zadání. Do textu 'zadani' VYPIŠ očíslovaný seznam: 1. Kolik je X? 2. Kolik je Y? 3. Kolik je Z? (Tím vznikne třímístný kód). Do anglického 'promptu' pro obrázek přesně vypiš počty těchto předmětů (např. 2 wheels, 4 cones, 3 bricks), aby je ilustrátor nakreslil správně."},
