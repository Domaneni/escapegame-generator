...
PUZZLE_CATALOG = {
    ...
    "pigpen_cipher": {"name": "Zednářská šifra", "instr": "Vymysli šifru se symboly. Do textu 'zadani' přímo vypiš textovou legendu pro děti. Obrazový prompt generuje jen 'starou kamennou desku se znaky'."},
